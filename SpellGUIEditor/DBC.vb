...
Public Class DBC
    ...
    Public Sub SaveCurrentSpell(ByVal index As Integer)
        ...
        SpellDBC.records(index).SpellName_String = Form1.dt.Rows(0).Item(136)
        SpellDBC.records(index).SpellNameFlag = Form1.dt.Rows(0).Item(137)
        SpellDBC.records(index).Rank_String = Form1.dt.Rows(0).Item(138)
        SpellDBC.records(index).RankFlags = Form1.dt.Rows(0).Item(139)
        SpellDBC.records(index).Description_String = Form1.dt.Rows(0).Item(140)
        SpellDBC.records(index).DescriptionFlags = Form1.dt.Rows(0).Item(141)
        SpellDBC.records(index).ToolTip_String = Form1.dt.Rows(0).Item(142)
